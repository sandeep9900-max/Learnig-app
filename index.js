...
const createEmployee = require("./modal/users");
...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "Online course Api management",
      contact: {
        name: "RecraftRelic",
        url: "https://recraftrelic.com/",
        email: "contact@recraftrelic.com",
      },
